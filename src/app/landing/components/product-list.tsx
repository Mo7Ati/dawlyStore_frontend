    ...
    return (
        <section className="container mx-auto">
            <div className="grid grid-cols-1 gap-6 p-8 sm:grid-cols-2 xl:grid-cols-4">
                <div
                    data-slot="card"
                    className="bg-card text-card-foreground flex flex-col gap-6 relative overflow-hidden rounded-md border py-0 shadow-none transition-all hover:shadow-md"
                >
                    <div data-slot="card-content" className="px-0">
                        <div className="relative aspect-square w-full overflow-hidden">
                            <Image
                                alt="classNameic White Sneakers"
                                className="size-full object-cover"
                                loading="lazy"
                                width="500"
                                height="500"
                                src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=500&amp;auto=format&amp;fit=crop&amp;q=60&amp;ixlib=rb-4.0.3"
                            />
                            <div className="absolute start-2 top-2 z-20"><span data-slot="badge"
                                className="justify-center rounded-md border text-xs font-medium w-fit whitespace-nowrap shrink-0 [&amp;&gt;svg]:size-3 [&amp;&gt;svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden border-transparent [a&amp;]:hover:bg-primary/90 flex items-center gap-1 px-2 py-1 text-white backdrop-blur-xs bg-black"><svg
                                    ...
                                    stroke-linejoin="round" className="lucide lucide-flame size-3">
                                    <path
                                        d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z">
                                    </path>
                                </svg><span className="text-xs font-medium">Trending</span></span></div>
                            <div
                                ...
                                </svg><span>4.5</span><span className="text-muted-foreground">| 1.2k</span></div>
                            <div className="absolute end-2 bottom-2 z-10"><button data-slot="button"
                                ...
                                aria-label="View similar products"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                </svg><span className="ms-6 text-xs whitespace-nowrap opacity-0 group-hover:opacity-100">VIEW
                                    SIMILAR</span></button></div><button data-slot="button"
                        ...
                        <div className="p-4">
                            <div className="space-y-2">
                                <h3 className="font-medium text-balance">classNameic White Sneakers</h3>
                                <p className="text-muted-foreground text-sm text-balance">Comfortable everyday wear</p>
                            </div>
                            <div className="flex items-center gap-2"><span className="font-semibold">$29</span><span
                                className="text-muted-foreground text-sm line-through">$49</span><span className="text-sm">(50%
                                    OFF)</span></div>
                        </div>
                    </div>
                </div>
